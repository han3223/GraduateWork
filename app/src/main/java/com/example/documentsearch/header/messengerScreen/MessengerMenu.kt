...
import com.example.documentsearch.header.documentScreen.sort.MessengerMenuAddFriend
import com.example.documentsearch.header.documentScreen.sort.MessengerMenuCreateGroup
import com.example.documentsearch.header.documentScreen.sort.MessengerMenuFriends
import com.example.documentsearch.header.documentScreen.sort.activeSortElement
...
fun MessengerMenu() {
    val listSort = listOf(
        MessengerMenuCreateGroup,
        MessengerMenuAddFriend,
        MessengerMenuFriends,
    )
    ...
    Box(
        ...
        Column(modifier = Modifier.padding(top = 100.dp, bottom = 15.dp)) {
